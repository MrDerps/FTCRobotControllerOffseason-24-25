...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 8101.87747; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 7093.50413; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -8921.78956; // x position of the perpendicular encoder (in tick units)
    }
